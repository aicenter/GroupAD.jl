...
"""
	fit_bag!(model::VAE, data::Tuple, loss::Function; max_train_time=82800, lr=0.001, 
		batchsize=64, patience=30, check_interval::Int=10, kwargs...)

Modification of the fit function to incorporate training of instance VAE on bags,
with the usage of Chamfer distance etc.
"""
function fit_bag!(model::VAE, data::Tuple, loss::Function; max_iters=100000, max_train_time=82800, 
	lr=0.001, batchsize=64, patience=30, check_interval::Int=10, kwargs...)
	history = MVHistory()
	opt = ADAM(lr)
	...
	# prepare data for Neural Statistician and bag VAE
